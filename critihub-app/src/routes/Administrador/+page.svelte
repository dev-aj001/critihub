<script>
 ...
 const unsub = onSnapshot(doc(db, "usuariosnew","0jBtn64PkFTlh76B0rQo"), (doc) => {
  const source = doc.metadata.hasPendingWrites ? "Local" : "Server";
  console.log(source, " data: ", doc.data());
});
  async function obtenerDatosFirestore() {

  const querySnapshot = await getDocs(collection(db, "Peliculas","1","reseñas"));
...
<section>
  ...
  <div class="col-md-4">
    <div class="form-group mb-4">
       <button on:click={() => (showModal = true)} class="btn btn-primary"  >Agregar</button> 
...
<Modal1 bind:showModal>
</Modal1>

<Modal2 bind:showModalp>
</Modal2>
